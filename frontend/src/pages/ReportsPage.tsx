        ...
        <div className="flex flex-col max-w-[1200px] w-full flex-1 gap-6">
          <div className="flex flex-wrap items-end justify-between gap-4 pb-2 border-b border-[#e5e7eb] dark:border-[#282e39]/50">
            <div className="flex flex-col gap-1">
              <h1 className="text-3xl md:text-4xl font-black leading-tight tracking-[-0.033em]">Reports</h1>
              <p className="text-[#6b7280] dark:text-[#9da6b9] text-base font-normal">Analytics coming soon</p>
            </div>
          </div>
