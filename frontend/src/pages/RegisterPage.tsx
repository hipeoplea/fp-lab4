...
export default function RegisterPage() {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Start creating engaging quizzes today for free."
    ...
    >
      <form className="flex flex-col gap-5" onSubmit={onSubmit} noValidate>
        <label className="flex flex-col gap-2">
          <span className="text-slate-900 dark:text-white text-base font-medium leading-normal">Username</span>
        ...
        <label className="flex flex-col gap-2">
          ...
          <p className="text-xs text-slate-500 dark:text-[#9da6b9] mt-2 pl-2">Must be at least 8 characters long.</p>
        </label>
        <button
