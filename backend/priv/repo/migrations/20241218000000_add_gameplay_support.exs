defmodule Quiz.Repo.Migrations.AddGameplaySupport do
  ...
  def change do
    ...
    create(
      unique_index(:session_players, [:session_id, :player_token],
    ...
    create(
      index(:session_answers, [:session_id, :player_id, :question_id], name: :idx_session_answers_unique_by_question)
    )
  end
end
